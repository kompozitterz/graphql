...
function home() {
    ...
    titledivConnexion.textContent = "Login";
...
function MAJpage(user) {
    ...
    name.textContent = 'Bienvenue ' + user.firstName + ' ' + user.lastName;
    ...
    lineReceived.setAttribute('stroke', 'var(--second-main-color)');
    ...
    // Calculer la position x et y pour centrer le rectangle
    let rectX = (100 - 80) / 2 - 14.5;
    let rectY = (100 - 80) / 2;
    ...
    for (let i = 0; i < user.listTransaction.length; i++) {
        ...
        if (i != 0) {
            ...
            line.setAttribute('stroke', 'var(--main-color)');
